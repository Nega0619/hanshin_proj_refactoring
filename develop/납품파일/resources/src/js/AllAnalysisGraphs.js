...
function drawAllAnalysisGraphs() {
    ...
    if (Object.keys(cancers).length != 0){
        var cancerConfig = getCancerConfig();
        var ctx01 = document.getElementById("allCancers");
        new Chart(ctx01, cancerConfig);
    }
    if (Object.keys(chronics).length != 0){
        var chronicConfig = getChronicConfig();
        var ctx02 = document.getElementById("allChronics");
