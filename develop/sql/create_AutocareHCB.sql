...
GO
ALTER TABLE [dbo].[BloodCodeInfo] ADD  CONSTRAINT [PK_HCB_FACTOR_INFO] PRIMARY KEY CLUSTERED 
(
	[index] ASC
...
SET ANSI_PADDING ON
GO
ALTER TABLE [dbo].[Candidate] ADD  CONSTRAINT [PK_Candidate] PRIMARY KEY CLUSTERED 
(
	[analysis_index] ASC,
	[AgeGroup] ASC,
	[PatientSex] ASC
...
GO
ALTER TABLE [dbo].[DiseasePerBloodCodes] ADD  CONSTRAINT [PK_BloodCodePerDisease] PRIMARY KEY CLUSTERED 
(
	[index] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[HanshinTrainData] ADD  CONSTRAINT [PK_HanshinTrainData] PRIMARY KEY CLUSTERED 
(
	[RegistKey] ASC
...
GO
ALTER TABLE [dbo].[InfinityTrainData] ADD  CONSTRAINT [PK_InfinityTrainData] PRIMARY KEY CLUSTERED 
(
	[RegistKey] ASC
)WITH (PAD_INDEX = ON, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = ON, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, FILLFACTOR = 90) ON [PRIMARY]
GO
